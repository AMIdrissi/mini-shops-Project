      ...
      <div>
        <div className="flex flex-col child:my-[12px] self-center">
          <motion.input
            ...
            style={{
              transition: "all 0.5s ease " + (0.1 - 0.1) + "s",
          ...
          <motion.input
            ...
            placeholder="CIN"
            style={{
              transition: "all 0.5s ease " + (0.2 - 0.1) + "s",
              opacity: whenInViewReg ? 1 : 0,
              transform: whenInViewReg
                ? "translateX(0px)"
                : "translateX(100px)",
          ...
          <motion.input
            ...
            placeholder="Email"
            style={{
              transition: "all 0.5s ease " + (0.3 - 0.1) + "s",
              opacity: whenInViewReg ? 1 : 0,
              transform: whenInViewReg
                ? "translateX(0px)"
                : "translateX(-100px)",
          ...
          <motion.input
            ...
            style={{
              transition: "all 0.5s ease " + (0.4 - 0.1) + "s",
              opacity: whenInViewReg ? 1 : 0,
              transform: whenInViewReg
                ? "translateX(0px)"
                : "translateX(100px)",
          ...
          <motion.input
            ...
            placeholder="Address"
            style={{
              transition: "all 0.5s ease " + (0.5 - 0.1) + "s",
              opacity: whenInViewReg ? 1 : 0,
              transform: whenInViewReg
                ? "translateX(0px)"
                : "translateX(-100px)",
