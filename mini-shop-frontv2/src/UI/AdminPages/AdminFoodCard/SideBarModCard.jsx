...
function SideBarModCard({ product }) {
  ...
  useEffect(() => {
    ...
    discountRef.current.value = product?.discount ? product?.discount : 0;
    ...
    <div className="my-5">
      ...
      <div className="flex items-center justify-center">
        ...
        {images.length > 0 ? (
          !showUrlInput ? (
            <motion.button
              className={`bg-gray-400 text-white px-[11px] py-[2px] font-bold font-customFont text-3xl rounded-xl mb-10 mx-3 flex items-center `}
              whileHover={{
                boxShadow: "0px 0px 10px rgb(126 ,133, 145)",
                backgroundColor: "rgb(126 ,133, 145)",
                scale: 1.02,
