  ...
  return (
    <div ref={MenuRef} className="w-1/2">
      <div
        ...
        className={
          clicked
            ? "text-[21px] bg-transparent border-[none] px-[1.5em] py-[1em] uppercase relative [transition:0.5s_ease] cursor-pointer h-full before:content-[''] before:absolute before:left-[0] before:bottom-[0] before:h-[2px] before:bg-[#4a4c50] before:[transition:0.5s_ease]  hover:delay-100 hover:before:w-full hover:bg-[#a2a1a6] hover:text-white after:content-[''] after:absolute after:left-[0] after:bottom-[0] after:h-[0] after:w-full after:bg-[#4a4c50] bg-[#a2a1a6] after:[transition:0.4s_ease] after:delay-[400ms] after:text-[aliceblue] text-white before:w-full flex items-center justify-center"
      ...
      >
        <button className="px-[6px]">button</button>
